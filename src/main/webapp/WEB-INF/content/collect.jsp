...
<font color="red">${requestScope.collectFail }</font>
    ...
    <div>
        <ul class="nav navbar-nav">
			...
			<li class="active"><a href="${pageContext.request.contextPath }/goCollect?user_id=${sessionScope.user.user_id }">收藏夹</a></li>
...
<tr>
<th width="10%">编号</th><th width="25%">书名 </th><th width="10%">价格</th><th width="30%">介绍</th><th align="center" width="25%">操作</th>
</tr>
